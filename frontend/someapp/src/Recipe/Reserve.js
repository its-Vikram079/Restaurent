...
console.log(result)
 ...
 navigate("/")
  ...
  <div className="col-md-4">
    ...
    <input type="text" className="form-control" id="validationDefault01" placeholder="Vikram Jassal" value={name} onChange={(e)=>setName(e.target.value)}/>
  ...
  <div className="col-md-4">
    ...
    <div className="input-group">
      <input type="email" className="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" placeholder="Jassal67@gmail.com" value={email} onChange={(e)=>setEmail(e.target.value)} />
    </div>
  </div>
  {/* people */}
  <div className="col-md-4">
  ...
  <div className="col-md-4">
    ...
    <input type="date" className="form-control" id="validationDefault02" placeholder="15-May-2024" value={date} onChange={(e)=>setDate(e.target.value)} />
