...
function Signup() {
  ...
  return (
    ...
    <input type="text" className="form-control" /* id="exampleInputEmail1"  */aria-describedby="emailHelp" placeholder='Vikram Jassal'  value={name}
  ...
  <div className="mb-3">
    ...
    <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder='vikramjassal01@gmail.com'  value={email}
  ...
  <div className="mb-3">
    ...
    <input type="password" className="form-control" id="exampleInputPassword1" placeholder='V345@$Jassal'  value={password}
